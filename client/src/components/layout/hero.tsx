...
function Hero() {
  return (
    ...
    >
      <img src={mainOrange} alt="Hero section background" className="absolute inset-0 w-full h-full object-cover hidden md:block" />
      <img src={mainAlternate} alt="Hero section background" className="absolute inset-0 w-full h-full object-cover block md:hidden" />
